...
public class MainActivity extends AppCompatActivity {
    ...
    //verilen izinler üzerinden izin alınmış mıkontrol ediyoruz.
    //eger izin alındı ise işleme geçiyoruz.
    //istenilen izinlerin sonuçlarını burada değerlendiriyoruz.
    //bize izin verip vermediğini anlayacağımız bir callback yani geri bildirim metodudur
